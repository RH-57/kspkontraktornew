                ...
                <div class="card info-card customers-card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            <h5 class="card-title">
                                Manage <span>| Procedures</span>
                            </h5>
                            <a class="btn btn-sm btn-primary" href="{{route('procedures.create')}}">Add</a>
                        </div>
                        <table class="table">
                            <thead>
                                <tr>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{route('procedures.edit', $procedure->id)}}" class="btn btn-sm btn-warning">
                                            <i class="bi bi-pen"></i>
                                        </a>
